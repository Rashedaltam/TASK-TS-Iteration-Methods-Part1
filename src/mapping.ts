...
const task1Solution :number[]= numbers.map((num)=>num*num)
  return task1Solution  ; // replace empty array with what you see is fit
}
...
function doubledNumbers(numbers: number[]): number[] {
  // write your code here...
const task1Solution2 : number[] = numbers.map((num)=> num*2)
  return task1Solution2; // replace empty array with what you see is fit
}
